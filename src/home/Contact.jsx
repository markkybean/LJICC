...
function Contact() {
  return (
    <section id="contact" className="bg-black max-w-[1160px] w-full mx-auto mt-40 px-[24px] lg:px-0 " >
        <div data-aos="fade-up" data-aos-duration="1000" className=" bg-gradient-to-r pt-[85px] pb-[35px] px-[40px] lg:px-[59px] from-[#45174c] to-[#1c164d] rounded-lg flex-col justify-end items-center gap-[132px] w-full">
            <div className="flex justify-center items-center flex-col">
                ...
                <p className="text-white text-[35px] lg:text-[40px] font-bold mb-[45px] text-center">Connect with us</p>
